...
<html lang="es">
	...
	<?php include'./nav.php';?>
		...
		<form id="formCrear" method="post" class="needs-validation" novalidate 	action="../controller/controllerUsuarios.php">
				...
				<div class="col-12 col-sm-4 mt-3">
					...
					<div class="col-12 col-sm-4 mt-3">
						...
						<div class="input-group has-validation">						
							...
							/>
							<div class="valid-feedback"></div>
                            <div class="invalid-feedback">Confirmar Password es requerido</div>
							<div data-toggle="password2" class="errorMensaje oculto">Password no coinciden</div>
						</div>
					</div>
                    ...
                    <div class="col-12 col-sm-2" style="margin-top:46px;">
							<button id="Guardar" class="btn btn-primary col-12" type="submit" >Guardar <i class="bi bi-file-plus text-light"></i></button>
					</div>
				</div>
